...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class MotionBlur : ImageEffectBase {
        ...
        public float extraBlurDownscaleAmount = 4;
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            if (extraBlur) {
                RenderTexture blurbuffer = RenderTexture.GetTemporary((int)(source.width / extraBlurDownscaleAmount), (int)(source.height / extraBlurDownscaleAmount), 0);
