    ...
    SubShader 
    {
        ...
        Pass 
        {
            ...
            v2f vert(appdata_base v)
            {
                ...
                const float fSamples = 2.0; // 2 alunperin -----
            ...
            {
                _BlendThreshold = 0.3; // 0.3 alunperin -----
                ...
                float startBlending2 = _ChangePoint + 0.7 - _BlendThreshold; // 0.7 alunperin -----
                float endBlending2 = _ChangePoint + 0.7 - _BlendThreshold; // 0.7 alunperin -----
